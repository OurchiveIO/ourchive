...
urlpatterns = [
    ...
    path('username/<int:pk>/', views.user_name_pk),
    path('username/<str:username>/', views.user_name, name='user-profile-parent'),
    path('users/<str:username>/', views.username, name='fe-user-profile'),
    ...
    path('username/<str:username>/edit', views.edit_user, name='fe-user-profile-edit'),
    path('username/<str:username>/account/edit', views.edit_account, name='fe-user-account-edit'),
    ...
    path('users/<str:username>/block', views.block_user, name='fe-block-user'),
