...
def get_work_obj(request, work_id=None):
    ...
    work_dict["locked_to_users"] = "true" if "work_locked" in work_dict else "false"
...
def get_bookmark_collection_obj(request):
    ...
    collection_dict["locked_to_users"] = 'true' if 'collection_locked' in collection_dict else 'false'
