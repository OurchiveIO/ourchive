...
urlpatterns = [
    ...
    path('users/<str:username>/import-works/', views.ImportWorks.as_view(), name='import-works'),
    path('users/<int:pk>/importstatus/', views.ImportStatus.as_view(), name='import-status'),
    path('users/profile/<int:pk>', views.UserNameDetailById.as_view(), name='user-detail-by-id'),
    path('users/profile/<str:username>', views.UserNameDetail.as_view(), name='user-detail'),
    path('users/<str:username>/export-chives/', views.ExportChives.as_view(), name='export-chives-be'),
    path('users/<str:username>/approvals/', views.UserApprovalList.as_view(), name='user-approvals'),
    path('users/<str:username>/remove-cocreator/', views.UserApprovalRemove.as_view(), name='be-remove-cocreator'),
    path('users/<str:username>/approve-cocreator/', views.UserApprovalApprove.as_view(), name='be-approve-cocreator'),
    path('users/<str:username>/cocreator-bulk-approve/', views.CocreateApproveBulk.as_view(), name='bulk-approve-cocreator'),
    path('users/<str:username>/cocreator-bulk-reject/', views.CocreateRejectBulk.as_view(), name='bulk-reject-cocreator'),
    ...
    path('users/<str:username>/subscriptions/users',
         views.UserSubscriptionList.as_view(), name='user-subscriptions-users'),
    ...
    path('users/<str:username>/subscriptions/works/<int:pk>',
         views.UserSubscriptionWorkManage.as_view(), name='user-subscriptions-works-manage'),
    path('users/<str:username>/subscriptions/works/create',
         views.UserSubscriptionWorkCreate.as_view(), name='user-subscriptions-works-create'),
    path('users/<str:username>/subscriptions/collections/<int:pk>',
         views.UserSubscriptionCollectionManage.as_view(), name='user-subscriptions-collections-manage'),
    path('users/<str:username>/subscriptions/collections/create',
         views.UserSubscriptionCollectionCreate.as_view(), name='user-subscriptions-collections-create'),
    ...
    path('savedsearches/', views.SavedSearchesList.as_view(), name='savedsearches'),
    path('savedsearches/<int:pk>/', views.SavedSearchDetail.as_view(), name='savedsearch-detail'),
    path('users/<str:username>/savedsearches',
         views.UserSavedSearchesList.as_view(), name='user-saved-searches'),
