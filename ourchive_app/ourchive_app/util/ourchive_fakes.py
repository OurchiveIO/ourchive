...
class OurchiveFakes():
    ...
    def generate_settings(self, obj_count=1, persist_db=False):
        pass

    def generate_work_types(self, obj_count=1, persist_db=False):
        pass

    def generate_tag_types(self, obj_count=1, persist_db=False):
        pass

    def generate_attribute_types(self, obj_count=1, persist_db=False):
        pass

    def generate_comments(self, obj_count=1, persist_db=False):
        pass

    def generate_anthologies(self, obj_count=1, persist_db=False):
        pass

    def generate_series(self, obj_count=1, persist_db=False):
        pass

    def generate_notifications(self, obj_count=1, persist_db=False):
        pass
